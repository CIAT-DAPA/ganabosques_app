    ...
    <main className={CSS_CLASSES.pageContainer}>
      ...
      <header className={CSS_CLASSES.headerSection}>
        <div className={CSS_CLASSES.contentWrapper}>
          <h1 className={CSS_CLASSES.title}>Dashboard de Alertas</h1>

          <hr className={CSS_CLASSES.separator} />

          <p className={CSS_CLASSES.description}>
            Consulta el estado de alertas de deforestación de los predios .
            Este módulo te permite visualizar los datos tabulados con paginación,
            ordenar por diferentes columnas y localizar los predios directamente en el mapa.
          </p>
        </div>
      </header>
